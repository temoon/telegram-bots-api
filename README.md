...
A Go library for working with the [Telegram Bot API](https://core.telegram.org/bots/api). Implements all methods and types from Telegram Bots API version 9.5.0.
