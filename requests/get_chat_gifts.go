...
func (r *GetChatGifts) Call(ctx context.Context, b *telegram.Bot) (response interface{}, err error) {
	response = new(telegram.OwnedGifts)
	err = b.CallMethod(ctx, "getChatGifts", r, response)
	return
}

func (r *GetChatGifts) GetValues() (values map[string]interface{}, err error) {
...
func (r *GetChatGifts) GetFiles() (files map[string]io.Reader) {
	return
}
